...
class InventoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create inventory' do
    assert_difference('Inventory.count') do
      post inventories_url, params: { inventory: { name: @inventory.name, users_id: @inventory.users_id } }
    end
  ...
  test 'should update inventory' do
    patch inventory_url(@inventory), params: { inventory: { name: @inventory.name, users_id: @inventory.users_id } }
